class FastFloat < Formula
  ...
  url "https://github.com/fastfloat/fast_float/archive/refs/tags/v8.2.7.tar.gz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, all: "79fefab12d467922c764b1490d315f83f4b812c8737982ad104c0709a069b6a6"
  end
