class Nanobind < Formula
  ...
  url "https://github.com/wjakob/nanobind/archive/refs/tags/v2.15.0.tar.gz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, all: "6a7e269f828e7f8d7c9ac1804586b45d4e9cda3294ff145a4a5ddcb0c2bdf40a"
  end
