class Mbt < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "04b53a557925504e8af4716cbcc75230a274fc994c6581ba52125f0392366883"
  ...
  def install
    ldflags = "-X main.Version=#{version} -X main.BuildDate=#{time.iso8601}"
