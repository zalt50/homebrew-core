class Nak < Formula
  ...
  url "https://github.com/fiatjaf/nak/archive/refs/tags/v0.20.6.tar.gz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "6c7d21bbabf4ad37617d0e0905397db797ef15c202552289dea5717d864b6ccf"
