class Mpfrcx < Formula
  ...
  livecheck do
    url "https://www.multiprecision.org/mpfrcx/download.html"
    regex(/href=.*?mpfrcx[._-]v?(\d+(?:\.\d+)+)\.t/i)
  end

  bottle do
    sha256 cellar: :any,                 arm64_golden_gate: "2dcd28ef27fb0ec2a4d9c4d8a0e4a1e34c81d77fb801f0d54214181819649218"
    ...
    sha256 cellar: :any,                 sonoma:            "66c8164a31ba3594d87f7cb29062b9562413cc71adc90ba96178cb630f4b332a"
