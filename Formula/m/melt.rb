class Melt < Formula
  ...
  bottle do
    rebuild 1
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "786d0b373d98f0e726d1ed74a2e00c988d509593179e792e1dfe0c47169680d5"
  ...
  def install
    system "go", "build", *std_go_args, "./cmd/melt"
