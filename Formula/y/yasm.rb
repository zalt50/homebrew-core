class Yasm < Formula
  ...
  mirror "https://github.com/yasm/yasm/releases/download/v1.3.0/yasm-1.3.0.tar.gz"
  ...
  bottle do
    rebuild 1
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "5da29404532f64edf5e78131339df1d486c1ddbfb74862f7874353cbc7f2f95c"
