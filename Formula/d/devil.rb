class Devil < Formula
  ...
  stable do
    ...
    patch do
      ...
      type :backport
      resolves "https://github.com/DentonW/DevIL/issues/48"
    end
    ...
    patch do
      ...
      type :backport
      resolves "https://github.com/DentonW/DevIL/pull/91"
    end
  end

  bottle do
    sha256 cellar: :any,                 arm64_golden_gate: "857198733f91d996a227c7732e7fa868a58d3971ecd3bb5e918266322a1f4f64"
