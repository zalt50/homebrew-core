class Lightning < Formula
  ...
  url "https://ftpmirror.gnu.org/lightning/lightning-2.2.3.tar.gz"
  ...
  bottle do
    sha256 cellar: :any,                 arm64_golden_gate: "ec20822e2aef81b0d3e45aa57869f335888f031b5e9a590b9430230a5a4f040f"
