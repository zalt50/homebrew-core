class Makeicns < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "9d4ca911915d827246cff071c1667bca9046cc7dfe2ba86318a058d05b78084f"
  ...
  patch :p0 do
    file "Patches/makeicns/patch-IconFamily.m.diff"
  end
