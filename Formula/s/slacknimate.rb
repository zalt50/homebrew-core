class Slacknimate < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "9971e988e4ac800051effe15901077b323625c6cf5adeea6bac6a466a4fcb099"
  ...
  def install
    system "go", "build", *std_go_args(ldflags: "-X main.version=#{version}"), "./cmd/slacknimate"
  end
