class Pacvim < Formula
  ...
  bottle do
    rebuild 1
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "5da4b1490ca7db02c03fc297d623cd9824ab4507c22ba44b78b896c706b3a807"
  ...
  patch do
    on_linux do
      ...
      type :unofficial
      resolves "https://github.com/jmoon018/PacVim/pull/31"
    end
  end
