class AbAv1 < Formula
  ...
  url "https://github.com/alexheretic/ab-av1/archive/refs/tags/v0.11.7.tar.gz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "0644477f88d598451369a7dbc701713f7236e67420e6a45380e7bf484a3d6a24"
  ...
  test do
    ...
    system formula_opt_bin("ffmpeg")/"ffmpeg", "-filter_complex", "testsrc=rate=1:duration=5", "test.mp4"
