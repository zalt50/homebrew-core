class WrenCli < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "387b1963ccb6fef07cd32e66af4fbd86769d075774d02eb08a1d6ff1c9ccadf8"
  ...
  patch do
    ...
    type :backport
    resolves "https://github.com/wren-lang/wren/issues/1086"
  end
