class Wush < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "62d3f2da5100aa8a0a89de01c4aae4587e0c2ef4e98a3b4f78e2df314581d26a"
  ...
  def install
    system "go", "build", *std_go_args(ldflags: "-X main.version=#{version}"), "./cmd/wush"
  end
