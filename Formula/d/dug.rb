class Dug < Formula
  ...
  url "https://github.com/unfrl/dug/archive/refs/tags/0.0.100.tar.gz"
  ...
  bottle do
    rebuild 1
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "41a7f6f4d340f53402d1f29394a0f2b608397d7e5a853dfa6b05ac1681679e3e"
