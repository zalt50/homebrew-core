class Cariddi < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "27681c82372b67c46f629d614bae9d21b067948f9851bcef8cf414153eaefcf7"
  ...
  def install
    system "go", "build", *std_go_args, "./cmd/cariddi"
  end
