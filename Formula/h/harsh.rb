class Harsh < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "04b518be9a55bf1ceb6279a6408c33b19948726b2b5fdd9989243e07499949b3"
  ...
  def install
    system "go", "build", *std_go_args(ldflags: "-X github.com/wakatara/harsh/cmd.version=#{version}")
