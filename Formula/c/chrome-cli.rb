class ChromeCli < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "ac87f88868a6f3cecfd40fe200f5d02ff3e2429f6858769bb8ddc9ec03d2d3bd"
  ...
  def install
    # Release builds
    xcodebuild "-arch", Hardware::CPU.arch.to_s, "SYMROOT=build", "MACOSX_DEPLOYMENT_TARGET=#{MacOS.version}"
