class X8664ElfGrub < Formula
  ...
  bottle do
    rebuild 1
    sha256 arm64_golden_gate: "cb3916d196c369d89f9588c56da5cd85bdafbce16d7e0926129eb597fdb99ba6"
  ...
  resource "unifont" do
    url "https://ftpmirror.gnu.org/unifont/unifont-16.0.02/unifont-16.0.02.pcf.gz", using: :nounzip
