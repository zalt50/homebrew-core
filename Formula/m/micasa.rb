class Micasa < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "e9fc00a47acd14a38248fbcef8d10531a0365fa2bba941a2099b31f96b6cd336"
  ...
  def install
    system "go", "build", *std_go_args(ldflags: "-X main.version=#{version}"), "./cmd/micasa"
  end
