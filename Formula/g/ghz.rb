class Ghz < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "20f203a2ff7da636e0f4222fbf7e8d9b37cb00efd177a5a1a664edf758d3f7f2"
  ...
  def install
    system "go", "build", *std_go_args(ldflags: "-X main.version=#{version}"), "./cmd/ghz"
  end
