class Utf8cpp < Formula
  ...
  url "https://github.com/nemtrif/utfcpp/archive/refs/tags/v4.2.1.tar.gz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, all: "91979507787b320aa978b9fe793d1d72b5c50c7e73529897dbe5f09c75fb0e90"
  end
