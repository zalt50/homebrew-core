class Openmama < Formula
  ...
  bottle do
    sha256 cellar: :any,                 arm64_golden_gate: "cb70e6a5d81c608f9ab3d58946261ddf62c521c3f7f273b53e3820ce1d65eb5e"
  ...
  def install
    args = %W[
      ...
      -DAPRUTIL_ROOT=#{formula_opt_prefix("apr-util")}
      -DPROTON_ROOT=#{formula_opt_prefix("qpid-proton")}
