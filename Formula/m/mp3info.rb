class Mp3info < Formula
  ...
  bottle do
    rebuild 1
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "cbad299030bcf207e35e0fbd6d5174b5536f3da565e6dcae184cc33701f850e7"
  ...
  patch :p0 do
    file "Patches/mp3info/patch-mp3tech.c.diff"
  end
