class Rp < Formula
  ...
  url "https://github.com/0vercl0k/rp/archive/refs/tags/v2.1.5.tar.gz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "2c50e1719468c4421f7e0c2a9f2f5cc27e98a928a4e4bfd252289bcebc30ca10"
