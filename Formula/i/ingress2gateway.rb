class Ingress2gateway < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "4094fa8098bb209ee2320b706cfafc3426f2b13e09c106065285b55bef2b79e0"
  ...
  def install
    ldflags = "-X github.com/kubernetes-sigs/ingress2gateway/pkg/i2gw.Version=#{version}"
