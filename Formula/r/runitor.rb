class Runitor < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "1855dfd307d6f72334d87b6d2cb348eb2da1ea0dcfbcadd66bed213e6e7363e0"
  ...
  def install
    system "go", "build", *std_go_args(ldflags: "-X main.Version=#{version}"), "./cmd/runitor"
  end
