class Taze < Formula
  ...
  url "https://registry.npmjs.org/taze/-/taze-19.17.1.tgz"
  sha256 "02aa4067d6a5c6cf42a35b484cffe4e58a2d253a33ef93cd914a9eb2eff66d61"
  license "MIT"
  head "https://github.com/antfu-collective/taze.git", branch: "main"

  bottle do
    sha256 cellar: :any_skip_relocation, all: "aa9beed42f056c3a4030007f6d6c887c2c07b463724f373f9ebe870416ff70fa"
  end
