class Svu < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "608bf2bd67b527cbe25ef19c9c3abf039714cfc0f62147f39087d6bd74f62528"
  ...
  def install
    ldflags = "-X main.version=#{version} -X main.commit=#{tap.user} -X main.date=#{time.iso8601} -X main.builtBy=#{tap.user} -X main.treeState=clean"
