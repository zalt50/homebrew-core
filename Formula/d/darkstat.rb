class Darkstat < Formula
  ...
  bottle do
    rebuild 1
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "7cbe6221e6f53b1f5534d7500b388c6af71af6b61073209e9e3267469e34fef3"
  ...
  patch do
    file "Patches/darkstat/clock_gettime.patch"
  end
