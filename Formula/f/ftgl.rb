class Ftgl < Formula
  ...
  bottle do
    sha256 cellar: :any,                 arm64_golden_gate: "4c22745ef1829ac4a288dc9582fd7f8b5198eb571f0369c5fae4902e7e0fe5a9"
  ...
  def install
    ...
    args << "--with-gl-inc=#{formula_opt_include("mesa-glu")}" if OS.linux?
