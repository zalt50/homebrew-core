class AwsConsole < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "3437c5a6b2336d47ac4ffd754eed55389a3935374cae9e68393d2b1f2d4c5375"
  ...
  def install
    system "go", "build", *std_go_args, "./cmd/aws-console"
