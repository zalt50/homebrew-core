class GoJsonnet < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "ec1e44f6f1040faae87b70a28e06a1deaad22cdb32d25561c55dec3cf1956fba"
  ...
  def install
    ...
    system "go", "build", *std_go_args(output: bin/"jsonnet-lint"), "./cmd/jsonnet-lint"
    system "go", "build", *std_go_args(output: bin/"jsonnet-deps"), "./cmd/jsonnet-deps"
  end
