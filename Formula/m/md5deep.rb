class Md5deep < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_golden_gate: "e19067932013d8bba51f9a9c3c3b3a0bc1787c5234e30f280b14c17a75fc658d"
  ...
  patch do
    ...
    type :backport
    resolves "https://github.com/jessek/hashdeep/pull/361"
  end
  ...
  patch do
    ...
    type :unofficial
    resolves "https://github.com/jessek/hashdeep/pull/385"
  end
